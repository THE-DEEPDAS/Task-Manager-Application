        ...
        <View style={styles.form}>
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              onChangeText={(text) => setFormData(prev => ({ ...prev, task_name: text }))}
          ...
          <View style={styles.inputGroup}>
            <Text style={styles.label}>Priority (1-100)</Text>
            <TextInput
              style={styles.input}
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              onChangeText={(text) => setFormData(prev => ({ ...prev, dependencies: text }))}
